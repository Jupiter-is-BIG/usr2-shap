...
# Note: a chroma-only "color saturation" distortion (CS) was deliberately
# omitted here. The video pipeline converts frames to grayscale immediately
# after distortion, and saturation only perturbs Cb/Cr, leaving luma (Y)
# essentially unchanged, so it wouldn't reach the video encoder.
